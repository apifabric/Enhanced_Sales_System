...
resourcename="salessystemiter1"  # lower case, only
resourcegroup="salessystemiter1_rg"
...
# git clone https://github.com/apilogicserver/salessystemiter1.git
# cd salessystemiter1
...
az group create --name salessystemiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group salessystemiter1_rg --sku S1 --is-linux
az container create --resource-group salessystemiter1_rg --name salessystemiter1 --image apilogicserver/salessystemiter1:latest --dns-name-label salessystemiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//salessystemiter1.westus.azurecontainer.io:5656'
