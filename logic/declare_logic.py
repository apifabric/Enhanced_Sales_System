...
def declare_logic():
    ...
    # Customer balance is calculated as the sum of unpaid order totals.
    Rule.sum(derive=Customer.balance, as_sum_of=Order.amount_total, where=lambda row: row.notes != 'Paid')

    # Order amount_total is calculated as the sum of item amounts.
    Rule.sum(derive=Order.amount_total, as_sum_of=Item.amount)

    # Item amount is calculated based on the quantity and unit price.
    ...
    # Enforces that customer balance must not exceed the credit limit.
